...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, stock, sinopsis, penulis, image) VALUES('$name', '$price', $stock, '$sinopsis', '$penulis', '$image')") or die('query failed');

      if($add_product_query){
         if($image_size > 2000000){
            $message[] = 'Size gambar terlalu besar';
         }else{
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="penulis" class="box" placeholder="Masukkan nama penulis produk" required>
      <input type="number" min="0" name="price" class="box" placeholder="Masukkan harga produk" required>
      <input type="number" name="stock" class="box" placeholder="Masukkan stok produk" required>
      <textarea name="sinopsis" class="box" placeholder="Masukkan sinopsis produk" required></textarea>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="update_stock" value="<?php echo $fetch_update['stock']; ?>" min="0" class="box" required placeholder="Masukan stok produk">
      <input type="text" name="update_penulis" value="<?php echo $fetch_update['penulis']; ?>" class="box" required placeholder="Masukan nama produk">
